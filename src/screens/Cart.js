          ...
          <tbody>
            {data.map((food, index) => (
              <tr>
                ...
                <td ><button style={{color:'white'}} className="btn p-0"><Delete onClick={() => { dispatch({ type: "REMOVE", index: index }) }} /></button> </td></tr>
            ))}
          </tbody>
        </table>
        <div><h1 className='fs-2 mt-3' style={{color:'white'}} >Total Price: {totalPrice}/-</h1></div>
        <div>
